...
\hypersetup{
  ...
  pdfauthor={Professor Marie Curie; Dr Pierre Curie},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\author{\sf{\Large\textbf{Professor Marie Curie} \\\large Nobel Prize,
PhD\\[0.5cm]}{\Large\textbf{Dr Pierre Curie} \\\large Nobel Prize,
PhD\\[0.5cm]}}
\lfoot{\sf Curie, Curie: 5 September 2024}
\begin{document}
\maketitle
...
\includegraphics{test_files/figure-pdf/fig-density-1.pdf}
