...
setwd("/Users/shabarish/Desktop/Project/Learningtower_Rpackage") #Set your own working directory
...
if (!file.exists("data/student_all.rda")) {
    ...
    # Check if student_all was created successfully
    if (!exists("student_all")) {
        stop("Error: student_all object was not created.")
    }
...
# Proceed with the data manipulation
student_country_all <- left_join(student_all, countrycode, by = "country") %>%
    dplyr::filter(country_name %in%
        c("Australia", "Germany", "Peru", "Qatar", "Belgium",
          "Brazil", "Denmark", "Greece", "Thailand", "Singapore",
          "Canada", "Portugal")) %>%
